...
trait Assertions
{
    ...
    {
        Assert::that($this->dom()->findAll($selector)->text())->contains($expected, strict: false);
    ...
    {
        Assert::that($this->dom()->findAll($selector)->text())->doesNotContain($expected, strict: false);
